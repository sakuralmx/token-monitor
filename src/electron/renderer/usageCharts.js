...
(function exposeUsageCharts(root, factory) {
  ...
  const clientColors = {
    ...
    pi: '#000', zed: '#4173e7', kilocode: '#F8F676', commandcode: '#8C4EDD', micode: '#000000', zcode: '#000000', kiro: '#9046FF', codebuddy: '#6C4DFF', workbuddy: '#0DC8A5', proma: '#000000', reasonix: '#4d6bfe', cherrystudio: '#EA5E5D', dsh: '#4d6bfe',

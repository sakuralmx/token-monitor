...
(function exposeThemePresets(root, factory) {
  ...
  const VENDOR_ORDER = [
    ...
    'gemini', 'antigravity', 'kimi', 'qwen', 'grok', 'copilot', 'pi', 'zed', 'kilocode', 'commandcode', 'micode', 'zcode', 'kiro', 'codebuddy', 'workbuddy', 'proma', 'reasonix', 'cherrystudio', 'dsh', 'deepseek', 'xai', 'meta', 'mistral',

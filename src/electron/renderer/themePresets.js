...
(function exposeThemePresets(root, factory) {
  ...
  const VENDOR_ORDER = [
    ...
    'gemini', 'antigravity', 'kimi', 'qwen', 'grok', 'copilot', 'pi', 'zed', 'kilocode', 'commandcode', 'micode', 'zcode', 'kiro', 'codebuddy', 'workbuddy', 'proma', 'qodercn', 'qoder', 'reasonix', 'cherrystudio', 'dsh', 'deepseek', 'xai', 'meta', 'mistral',
